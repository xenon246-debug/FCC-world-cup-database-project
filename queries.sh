...
# Since we know the winner will score the most goals, winner_goals is sufficient
...
# The opponent team has to be taken into consideration as well hence the OR statement
